...
description: DOLAP 2026. DOLAP is the International Workshop on Design, Optimization, Languages and Analytical Processing of Big Data. The 28th edition of the workshop is co-located with the EDBT/ICDT 2026 conference and takes place in Tampere, Finland, on March 24, 2026. This page presents the scheduled program of DOLAP 2026.
show_sidebar: false
menubar: menu-2026
...
- Keynote - Prof. Tilmann Rabl. A Look at the Ecological Impact of Big Data Systems
- Interactive Panel on Sustainable Analytics
...
- <span style="color:#093"><b>Laurent Bindschaedler</b></span>. Semantic Caching for OLAP via LLM-Based Query Canonicalization (Short paper)
- Alan Petit, <span style="color:#093"><b>Matthew Damigos</b></span>, Laurent D'Orazio, Eleftherios Kalogeros. Computation of fuzzy joins over large collections of JSON data using semantic similarity (Short paper)
