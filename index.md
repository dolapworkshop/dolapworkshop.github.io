...
layout: page
title: ""
description: Official website of DOLAP. DOLAP is the International Workshop on Data management fOr anaLytics and Ai Processing. DOLAP is established as one of the reference places for researchers to publish their work in the broad area of data decision support systems, including data modeling, data management, and data analysis. The DOLAP workshop takes place within a well-known conference in the database area, usually EDBT/ICDT. The best papers published at DOLAP are invited to submit extended version to a special issue on a highly reputed international journal like Information Systems Data & Knowledge Engineering. The high-quality program of DOLAP includes invited keynotes from reputed speakers, a best paper award, a test-of-time award, and uses open proceedings.
show_sidebar: false
hide_hero: true
---
...
![DOLAP logo](/img/dolap_logo_2026_v2.jpg){: id="index-logo" }
